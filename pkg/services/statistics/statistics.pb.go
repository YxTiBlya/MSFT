...
type TopProductsRequest struct {
	...
	StartDate   *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=start_date,json=startDate,proto3" json:"start_date,omitempty"`
	EndDate     *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=end_date,json=endDate,proto3" json:"end_date,omitempty"`
	ProductType *StatisticsProductType `protobuf:"varint,3,opt,name=product_type,json=productType,proto3,enum=statistics.StatisticsProductType,oneof" json:"product_type,omitempty"`
}
...
type Product struct {
	...
	ProductType StatisticsProductType `protobuf:"varint,4,opt,name=product_type,json=productType,proto3,enum=statistics.StatisticsProductType" json:"product_type,omitempty"`
}
...
var file_statistics_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x4f, 0x66, 0x50, 0x72,
	0x6f, 0x66, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x0a, 0x73,
	...
	0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x65, 0x22, 0x33, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x41, 0x6d,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x22, 0xe2, 0x01, 0x0a,
	0x12, 0x54, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	,
...
var file_statistics_proto_goTypes = []interface{}{
	(StatisticsProductType)(0),        // 0: statistics.StatisticsProductType
	(*GetAmountOfProfitRequest)(nil),  // 1: statistics.GetAmountOfProfitRequest
	(*GetAmountOfProfitResponse)(nil), // 2: statistics.GetAmountOfProfitResponse
	(*TopProductsRequest)(nil),        // 3: statistics.TopProductsRequest
	(*TopProductsResponse)(nil),       // 4: statistics.TopProductsResponse
	(*Product)(nil),                   // 5: statistics.Product
	(*timestamppb.Timestamp)(nil),     // 6: google.protobuf.Timestamp
}
var file_statistics_proto_depIdxs = []int32{
	6, // 0: statistics.GetAmountOfProfitRequest.start_date:type_name -> google.protobuf.Timestamp
	6, // 1: statistics.GetAmountOfProfitRequest.end_date:type_name -> google.protobuf.Timestamp
	6, // 2: statistics.TopProductsRequest.start_date:type_name -> google.protobuf.Timestamp
	6, // 3: statistics.TopProductsRequest.end_date:type_name -> google.protobuf.Timestamp
	0, // 4: statistics.TopProductsRequest.product_type:type_name -> statistics.StatisticsProductType
	5, // 5: statistics.TopProductsResponse.result:type_name -> statistics.Product
	0, // 6: statistics.Product.product_type:type_name -> statistics.StatisticsProductType
	1, // 7: statistics.StatisticsService.GetAmountOfProfit:input_type -> statistics.GetAmountOfProfitRequest
	3, // 8: statistics.StatisticsService.TopProducts:input_type -> statistics.TopProductsRequest
	2, // 9: statistics.StatisticsService.GetAmountOfProfit:output_type -> statistics.GetAmountOfProfitResponse
	4, // 10: statistics.StatisticsService.TopProducts:output_type -> statistics.TopProductsResponse
...
func file_statistics_proto_init() {
	...
	file_statistics_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
